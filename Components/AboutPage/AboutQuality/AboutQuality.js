...
const AboutQuality = () => {
   ...
   <div className='bg-[#212121]'>
         <div className='grid grid-cols-1 md:grid-cols-2 px-[20px] md:px-[80px] gap-8 py-24'>
            {
                aboutQuality?.map(aboutQualite=><div className='h-[470px] md:h-[420px] relative'>
                    ...
                    <button className="bg-white absolute bottom-0 text-black active:bg-white hover:bg-[#C40017] hover:text-white mt-10 font-bold text-sm px-8 py-4 mb-10 md:mb-0 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">{aboutQualite.button}</button>
