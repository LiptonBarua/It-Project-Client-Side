            ...
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4 items-center">
                <div className="sm:col-span-2">
                    ...
                    <div className="mt-6 lg:max-w-sm">
                        <div>
                            ...
                            <button className="bg-white text-black active:bg-white hover:bg-[black] hover:text-white mt-10 font-bold text-sm px-8 py-4 mb-10 md:mb-0 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">View Location</button>
                        </div>
                ...
                <div className="space-y-2 text-sm">
                    <div className="flex items-center mt-1 space-x-3">
                        <a
                            href="/"
                            className="text-white hover:text-black transition-colors duration-300 hover:text-deep-purple-accent-400"
                        >
                ...
                <div>
                    <Link href='/' className=" text-orange-500 font-bold"> <img className='w-[160px] md:w-80' src="https://www.itsolutions.ae/images/ftr-logo-it-sol.svg" alt="" /></Link>
