...
const Solutions = () => {
    return (
        <div className="px-[20px] md:px-[80px] hero min-h-screen" style={{ backgroundImage: `url(https://www.itsolutions.ae/images/about-bg.png)` }}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white">
              ...
              <button class="bg-white text-black active:bg-white hover:bg-black hover:text-white mt-10 font-bold text-sm px-8 py-4 mb-10 md:mb-0 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
      >
 Explore More
</button>
              </div>
