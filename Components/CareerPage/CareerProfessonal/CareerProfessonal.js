...
const CareerProfessonal = () => {
    return (
        <div className='px-[20px] md:px-[52px] text-center flex justify-between items-center py-8 text-white' style={{backgroundImage: `url(https://i.ibb.co/g6SqxrJ/Copy-of-Black-and-Red-Gradient-Professional-Linked-In-Banner.png)`, backgroundRepeat: `no-repeat`, backgroundSize: `cover`}}>
