...
<h1 className='text-white font-semibold text-3xl pb-5'>QUICK ENQUIRY</h1>
        ...
        <form action="" className="space-y-4">
          ...
          <div className="mt-4 ms-auto">
            <button type="submit" className="inline-block w-full rounded-full bg-white  hover:bg-[#C60017] px-8 py-3 font-medium text-black hover:text-white sm:w-auto" >Submit</button>
                                {/* <button className="bg-white absolute bottom-0 text-black active:bg-white hover:bg-[#C40017] hover:text-white font-bold text-sm px-8 py-4 mb-10 md:mb-0 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Submit</button> */}
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3689.573489111011!2d91.84162477447407!3d22.369727890376875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ad2777c9c1cf83%3A0xb8796c419fa1021b!2sBahaddarhat%2C%20Chattogram!5e0!3m2!1sen!2sbd!4v1684591968657!5m2!1sen!2sbd" width="600" className='h-full' style={{border: `0`}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
